                            ...
                            const emlrtRTEInfo *srcLocation)
{
  ...
  emxCopy_real_T(sp, &dst->t, &src->t, srcLocation);
  emxCopy_real_T(sp, &dst->xx, &src->xx, srcLocation);
  emxCopy_real_T(sp, &dst->tt, &src->tt, srcLocation);
}
...
void emxFreeStruct_struct_T(const emlrtStack *sp, e_struct_T *pStruct)
{
  ...
  emxFree_real_T(sp, &pStruct->xx);
  emxFree_real_T(sp, &pStruct->tt);
}
                          ...
                          const emlrtRTEInfo *srcLocation)
{
  ...
  emxInit_int32_T(sp, &pStruct->colidx, 1, srcLocation);
  emxInit_int32_T(sp, &pStruct->rowidx, 1, srcLocation);
}
                            ...
                            const emlrtRTEInfo *srcLocation)
{
  ...
  emxInit_real_T(sp, &pStruct->t, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->xx, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->tt, 2, srcLocation);
}
...
/* End of code generation (main_emxutil.c) */
